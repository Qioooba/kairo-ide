...
const IDEA_MAC_KEYBINDINGS: IDEAKeybinding[] = [
  ...
  { command: 'editor.action.referenceSearch.trigger', keybinding: 'alt+f7', when: 'editorTextFocus' },
  ...
  // ── Search / Replace ────────────────────────────────────────
  { command: 'search.action.openInEditor', keybinding: 'cmd+shift+f' },
  { command: 'workbench.action.replaceInFiles', keybinding: 'cmd+shift+r' },
  ...
  { command: 'kairo.server.stop', keybinding: 'cmd+f2' },
  ...
  { command: 'workbench.action.toggleFullScreen', keybinding: 'ctrl+shift+f' },
  { command: 'workbench.action.openSettings', keybinding: 'cmd+,' },
  { command: 'workbench.action.showCommands', keybinding: 'cmd+shift+a' },
