...
const IDEA_WINDOWS_KEYBINDINGS: IDEAKeybinding[] = [
  ...
  { command: 'search.action.openInEditor', keybinding: 'ctrl+shift+f' },
  { command: 'workbench.action.replaceInFiles', keybinding: 'ctrl+shift+r' },
  ...
  { command: 'kairo.server.stop', keybinding: 'ctrl+f2' },
