...
const IDEA_KEYBINDINGS_MAC: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { action: 'Servers', idea: '⌘2', kairo: '⌘2' },
      { action: 'Deployments', idea: '⌘3', kairo: '⌘3' },
      { action: 'Builds', idea: '⌘4', kairo: '⌘4' },
      { action: 'Debug', idea: '⌘5', kairo: '⌘5' },
      { action: 'Problems', idea: '⌘6', kairo: '⌘6' },
      { action: 'TODO', idea: '⌘7', kairo: '⌘7' },
...
const IDEA_KEYBINDINGS_WIN: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { action: 'Conditional Breakpoint (条件断点)', idea: 'Ctrl+Shift+F8', kairo: 'Ctrl+Shift+F8' },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { action: 'Servers (服务器)', idea: 'Alt+2', kairo: 'Alt+2' },
      { action: 'Deployments (部署)', idea: 'Alt+3', kairo: 'Alt+3' },
      { action: 'Builds (构建)', idea: 'Alt+4', kairo: 'Alt+4' },
      { action: 'Debug (调试)', idea: 'Alt+5', kairo: 'Alt+5' },
      { action: 'Problems (问题)', idea: 'Alt+6', kairo: 'Alt+6' },
      { action: 'TODO', idea: 'Alt+7', kairo: 'Alt+7' },
      { action: 'Git', idea: 'Alt+9', kairo: 'Alt+9' },
    ],
  },
  {
    name: 'Bookmarks (书签)',
    ...
    <div className="kairo-cheatsheet-content">
      ...
      {!isMac && (
        <div style={{
          ...
          Kairo IDE 默认使用 IntelliJ IDEA Windows 快捷键方案，与 IDEA 完全一致。
        </div>
      )}
