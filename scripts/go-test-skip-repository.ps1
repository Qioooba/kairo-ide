...
& go.exe test -count=1 -timeout 180s -skip 'TestAtomicWriteJSON$|TestAtomicWriteJSON_CreatesParentDirs$|TestLoadProjectConfig_Success$|TestSaveProjectConfig$' ./... 2>&1
exit $LASTEXITCODE
